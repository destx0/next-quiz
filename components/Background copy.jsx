    ...
    <div className="fixed inset-0 z-0 pointer-events-none">
      ...
      >
        ...
        <defs>
          ...
          >
            <stop stopColor="rgba(66, 14, 71, 0)" offset="0.02"></stop>
            <stop stopColor="rgba(78, 186, 159, 0.15)" offset="0.2"></stop>
            <stop stopColor="rgba(0, 0, 0, 0)" offset="0.44"></stop>
            <stop stopColor="rgba(0, 0, 0, 0.25)" offset="0.62"></stop>
            <stop stopColor="rgba(148, 79, 167, 0.16)" offset="0.85"></stop>
            <stop stopColor="rgba(60, 6, 75, 0.01)" offset="0.96"></stop>
          </linearGradient>
        </defs>
      </svg>
    </div>
