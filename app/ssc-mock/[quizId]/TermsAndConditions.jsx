...
const QuestionStatusIcon = ({
  ...
  let shape = null;
  let textColor =
    isActive || (!isVisited && !isAnswered && !isMarked) ? "black" : "white";
      ...
      <div className="flex-grow overflow-auto p-8">
        ...
        <ol className="list-decimal list-inside space-y-4 mb-6">
          <InstructionItem>
            ...
            the examination will end by itself. You need not terminate the
        ...
        <ol className="list-decimal list-inside space-y-2 mb-6">
          ...
          <p className="mt-2">
            ...
            <strong>Question Paper</strong> button. This feature is provided, so
            that if you want you can just see the entire question paper at a
            glance.
          </p>
        </ol>

        <h2 className="text-2xl font-semibold mb-4">Answering a Question:</h2>
          ...
          <InstructionItem>
            ...
            <ol className="list-alpha list-inside ml-4 mt-2">
              ...
              <li>
                ...
                or without &quot;0&quot; before the decimal point. As many as
                four decimal points, e.g. 12.5435 or 0.003 or -932.6711 or 12.82
                can be entered.
              </li>
              <li>
        ...
        <ol className="list-decimal list-inside space-y-2">
          ...
          <InstructionItem>
            ...
            <strong>marked for review after answering</strong> will be
          ...
          <InstructionItem>
            After clicking the <strong>Save &amp; Next</strong> button for the
            last question in a Section, you will automatically be taken to the
            first question of the next Section in sequence.
          </InstructionItem>
          <InstructionItem>
