        ...
        <div className="space-y-6">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              >
                {LANGUAGES.map((lang) => (
                  <Radio key={lang.value} value={lang.value} size="sm">
                    {lang.label}
                  </Radio>
                ))}
              </RadioGroup>
          ...
          <Accordion defaultExpandedKeys={["1"]}>
            ...
            >
              <div className="space-y-4 px-2">
                ...
                {uploadType === "quizzes" && (
                  <div>
                    <SectionTitle>Upload Version</SectionTitle>
                    <RadioGroup
                      value={uploadVersion}
                    ...
                    >
                      ...
                      <Radio value="v1" description="Basic quiz structure">
                        Version 1.0
                      </Radio>
                    </RadioGroup>
                  </div>
          ...
          <div className="text-xs text-gray-500 mt-4">
            <p>💡 Default settings: Quiz upload (v2) with file input method</p>
          </div>
        </div>
      </CardBody>
    </Card>
