    ...
    <div className="flex flex-col h-screen bg-white">
      <div className="flex-grow p-8 overflow-auto">
        ...
        <div className="mb-6 p-4 bg-gray-100 rounded-md">
          <p className="font-bold mb-2">Duration: {durationMinutes} Minutes</p>
          <p className="font-bold mb-2">Total Questions: {numQuestions}</p>
          <p className="font-bold mb-2">
            Marks per Question: {marksPerQuestion}
          </p>
          <p className="font-bold mb-2">Maximum Marks: {totalMarks}</p>
          <p className="font-bold mb-4">
            Read the following instructions carefully:
          </p>
          <ol className="list-decimal list-inside space-y-2">
            <li>
              The test contains 4 sections having {numQuestions} questions.
            </li>
            <li>
            ...
            <li>
              You will be awarded {marksPerQuestion} marks for each correct
              answer and 0.5 will be deducted for each wrong answer.
            </li>
            <li>
        ...
        <div className="mb-6">
          <label className="flex items-center">
            ...
            <span className="ml-2 text-sm font-bold text-gray-700">
              ...
              disqualification. The decision of infinitymock will be final in
