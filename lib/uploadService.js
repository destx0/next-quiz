...
import { collection, addDoc, arrayUnion, updateDoc, doc, getDoc, setDoc } from "firebase/firestore";
...
export const updateTestBatch = async (testBatchId, quizId, quizData) => {
  try {
    ...
    if (existingExamIndex === -1) {
      ...
      console.log(`Updated primary quiz ${existingExam.primaryQuizId} with language versions`);
    }
